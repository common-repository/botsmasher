...
* Shortcode builder/save forms as post type [todo]
...
* Bug fix: correctly load textdomains
* Bug fix: correctly reference text domains
* Bug fix: switch sample shortcode to readonly textarea.
* Add notice about Botsmasher.com expired SSL certificate.
