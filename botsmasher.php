...
Version: 1.1.1
Author: Joe Dolson
Text Domain: botsmasher
Domain Path: /lang
Author URI: http://www.joedolson.com/

    Copyright 2013-2016 Joe Dolson (joe@joedolson.com)
...
add_action( 'plugins_loaded', 'botsmasher_load_textdomain' );
function botsmasher_load_textdomain() {
	load_plugin_textdomain( 'botsmasher',false, dirname( plugin_basename( __FILE__ ) ) . '/lang' );
}

//define( 'BS_DEBUG_TO', 'debug@joedolson.com' ); // use this to send debugging to Joe. Please, only if you contacted me first! Otherwise you will be blocked.
	...
	<div class="metabox-holder">
		<div class="ui-sortable meta-box-sortables">
			<div class="postbox">
				...
				<p>
				<strong><?php _e( 'The BotSmasher web site is giving me a security warning! WTF!', 'botsmasher' ); ?></strong><br />
				<?php _e( 'Yes, this is true. BotSmasher.com\'s security certificate has expired, but the service is still safe. All apologies.', 'botsmasher' ); ?>
				</p>
				</div>
...
<textarea readonly cols="50" rows="9" style="padding: 10px;border: none; background: transparent; font-family: monospace; ">
[botsmasher]
		...
		<div class="ui-sortable meta-box-sortables">
			<div class="postbox">
				...
				<div class="inside">
					...
					<p><?php _e("If you've found BotSmasher useful, then please consider <a href='http://wordpress.org/extend/plugins/botsmasher/'>rating it five stars</a>, <a href='http://www.joedolson.com/donate/'>making a donation</a>, or <a href='http://translate.joedolson.com/projects/botsmasher'>helping with translation</a>.",'botsmasher'); ?></p>
							<div>
					<p><?php _e('<a href="http://www.joedolson.com/donate/">Make a donation today!</a> Every donation counts - donate $5, $20, or $100 and help me keep this plug-in running!','wp-to-twitter'); ?></p>
...
";
	...
	<form method='post' action='$admin_url'>
        ...
        <p>
        <input type='checkbox' name='has_donated' id='has_donated' value='on' /> <label for='has_donated'>".sprintf(__('I have <a href="%1$s">made a donation to help support this plug-in</a>','botsmasher'),'http://www.joedolson.com/donate/')."</label>
        </p>
        <p>
        <label for='support_request'>".__('Support Request:','botsmasher')."</label><br /><textarea name='support_request' required aria-required='true' id='support_request' cols='80' rows='10' class='widefat'>".stripslashes($request)."</textarea>
		</p>
		<p>
